...
class BraceletsImport extends ProductsImport
{
    protected $filename = 'bracelets.csv';
    ...
    protected function formatData(array $data)
    {
        ...
        return [
            'slug' => $sku,
            'sku' => $sku,
            'group_sku' => $this->getGroupSku($itemName, $data[4], $stoneSize, $data[10]),
            'category_id' => 3,
            ...
            'style_id' => $this->getOrCreateStyleId($this->encodingValue($data[4])),
            'shape_id' => 0,
            ...
            'files' => $this->collectImages('bracelets/' . $data[25]),
        ];
    }
}