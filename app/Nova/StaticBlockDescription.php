...
class StaticBlockDescription extends Resource
{
    /**
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Translatable::make('Text')->rules('required')->trix(),
            HiddenField::make('Block type')->defaultValue('description')->hideFromIndex()->hideFromDetail()
        ];
    }
    ...
    {
        return 'static-blocks-description';
    }
