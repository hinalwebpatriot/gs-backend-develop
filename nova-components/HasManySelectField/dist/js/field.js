...
Nova.booting(function (Vue, router) {
    Vue.component('index-has-many-select-field', __webpack_require__(12));
    Vue.component('detail-has-many-select-field', __webpack_require__(15));
    Vue.component('form-has-many-select-field', __webpack_require__(18));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].apiUrl + '/items', { params: this.baseParams() }).then(function (response) {
    ...
    methods: {
        baseParams: function baseParams(additional) {
            return _extends({
        ...
        findVariants: function findVariants() {
            ...
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].apiUrl + '/search', {
        ...
        deleteItem: function deleteItem(id) {
            ...
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.delete(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].apiUrl + '/detach', {
                ...
                _this3.success('Successfully deleted!');
            });
        },

        attachItem: function attachItem(id) {
            var _this4 = this;

            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].apiUrl + '/attach', this.baseParams({ itemId: id })).then(function (response) {
                _this4.items.push(response.data);
                _this4.success('Successfully added!');
        ...
        containerClick: function containerClick(event) {
            var specifiedElement = document.getElementById('search-variants');
...
/* harmony default export */ __webpack_exports__["a"] = ({
    apiUrl: '/nova-vendor/has-many-select'
});
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "form-area", on: { click: _vm.containerClick } },
    [
      _c(
        "div",
        {
        ...
        [
          _c("div", { staticClass: "flex border-b border-40" }, [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "py-6 px-8 w-1/2 item-variants-box" }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                ...
                staticClass:
                  "w-full form-control form-input form-input-bordered search-input",
                attrs: { type: "text", placeholder: _vm.searchTitle },
                domProps: { value: _vm.search },
                on: {
                  keyup: function($event) {
                    return _vm.findVariants()
                  },
                  focus: function($event) {
                    return _vm.showVariants()
                  },
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: _vm.showVariantPanel,
                      expression: "showVariantPanel"
                    }
                  ],
                  staticClass: "variants",
                  attrs: { id: "search-variants" }
                },
                [
                  _c(
                    "ul",
                        ...
                        "li",
                        {
                          on: {
                            click: function($event) {
                              return _vm.attachItem(variant.id)
                            }
                          }
                        },
                        [
                          _c("div", { staticClass: "search-variant" }, [
                            _c("img", { attrs: { src: variant.img_url } }),
                            _vm._v(
                              "\n                                " +
                                _vm._s(variant.name) +
                                "\n                            "
          ...
          _c(
            "div",
            { staticClass: "list-searched-items" },
            [
      ...
      _c(
        "div",
        {
          ...
          staticClass: "bg-warning py-4 px-4"
        },
        [_c("p", [_vm._v("First save general information!")])]
      )
    ]
  )
}
